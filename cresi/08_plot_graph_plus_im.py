...
#         color = '#ffe281'
    elif speed >= 5 and speed < 8:
        color = '#fec357'
    elif speed >= 8 and speed < 12:
        color = '#fe9f45'
    elif speed >= 12 and speed < 16:
        color = '#fa7634'
    elif speed >= 16 and speed < 20:
        color = '#f24624'
...
###############################################################################
def make_color_dict_list(max_speed=45, verbose=False):
    color_dict = {}
    color_list = []
